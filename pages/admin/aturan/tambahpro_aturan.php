...
if (isset($_POST['submit']) || isset($_POST['confirmed'])) {
    ...
    // Remove bobot from processing
    // $bobot = $_POST['bobot'];

    try {
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $pdo = $conn->prepare('INSERT INTO tbl_aturan (kd_penyakit, kd_gejala) VALUES (:kd_penyakit, :kd_gejala)');
        $params = array(
        ...
        if ($pdo->execute($params)) {
            $content = '
                ...
                <h1 class="text-2xl font-bold text-gray-800 mb-4">Aturan Berhasil Ditambahkan!</h1>
                <p class="text-gray-600 mb-6">Aturan baru telah berhasil disimpan ke dalam sistem.</p>
                <a href="?pages=data_aturan" class="inline-block px-6 py-3 rounded-xl font-semibold text-white btn-primary">
                    <i class="fas fa-clipboard-list mr-2"></i> Kembali ke Data Aturan
                </a>
            ';
            ...
            $content = '
                ...
                <p class="text-gray-600 mb-6">Terjadi kesalahan saat menyimpan data aturan. Silakan coba lagi.</p>
                <a href="?pages=tambah_aturan" class="inline-block px-6 py-3 rounded-xl font-semibold text-white btn-error">
        ...
        $content = '
            ...
            <h1 class="text-2xl font-bold text-gray-800 mb-4">Tambah Aturan Gagal</h1>
