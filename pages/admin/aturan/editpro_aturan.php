...
if (isset($_POST['submit']) || isset($_POST['confirmed'])) {
    ...
    try {
        ...
        if ($stmt->execute($params)) {
            $content = '
                ...
                <h1 class="text-2xl font-bold text-gray-800 mb-4">Aturan Berhasil Diperbarui!</h1>
                <p class="text-gray-600 mb-6">Perubahan data aturan telah berhasil disimpan ke dalam sistem.</p>
            ...
            $content = '
                ...
                <p class="text-gray-600 mb-6">Terjadi kesalahan saat menyimpan perubahan data aturan.</p>
    ...
    $content = '
        ...
        <a href="?pages=data_aturan" class="inline-block px-6 py-3 rounded-xl font-semibold text-white btn-error">
            <i class="fas fa-clipboard-list mr-2"></i> Kembali ke Data Aturan
        </a>
    ';
    renderPage($content);
