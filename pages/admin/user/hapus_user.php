...
if (!isset($_GET['id'])) {
    renderErrorPage("ID user tidak ditemukan.");
    exit;
}
...
try {
    ...
    if ($stmt->execute()) {
        ...
        renderErrorPage("Gagal menghapus data user.");
    }
} catch (PDOException $e) {
    renderErrorPage("Error saat menghapus user: " . $e->getMessage());
    exit;
}
...
<body class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50 p-4">
    <div class="glass-card p-8 max-w-md w-full text-center success-animation">
        ...
        <h2 class="text-2xl font-bold text-gray-800 mb-3">User Berhasil Dihapus!</h2>
        <p class="text-gray-600 mb-6">Data user telah berhasil dihapus dari sistem.</p>
        <div class="flex justify-center">
            <a href="?pages=data_user" class="btn-primary px-6 py-3 rounded-lg text-white font-medium inline-flex items-center">
                <i class="fas fa-arrow-left mr-2"></i> Kembali ke Data User
            </a>
        </div>
    </div>
    <script>
...
<body class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50 p-4">
    <div class="glass-card p-8 max-w-md w-full text-center">
        ...
        <div class="flex justify-center space-x-4">
            <a href="?pages=data_user" class="btn-error px-6 py-3 rounded-lg text-white font-medium inline-flex items-center">
