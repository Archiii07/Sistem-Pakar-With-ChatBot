    ...
    <div class="w-full max-w-4xl">
        ...
        <div class="animated-gradient rounded-t-3xl p-8 text-center text-white relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <p class="text-white/90 font-medium">Lengkapi formulir untuk menambahkan pengguna baru ke sistem</p>
            </div>
        </div>

        <!-- Main form container -->
        <div class="glass-card rounded-b-3xl p-8 md:p-10">
            <form id="userForm" action="?pages=tambahpro_user" method="post" enctype="multipart/form-data">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute right-4 top-4 text-green-500 opacity-0" id="name-check">
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute right-4 top-4 text-green-500 opacity-0" id="email-check">
                                <i class="fas fa-check-circle"></i>
                            </div>
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <button type="button" onclick="checkUsername()"
                                class="absolute right-4 top-4 text-indigo-500 hover:text-indigo-700 transition">
                ...
                <div class="mt-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-md mx-auto">
                        <!-- Admin Role -->
                        <div class="role-card">
                            <input type="radio" id="admin" name="title" value="admin" class="hidden peer" required>
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    Apakah Anda yakin ingin menyimpan data pengguna ini?
                                </p>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function checkUsername() {
        ...
        if (!username) {
            Swal.fire({
                ...
                text: 'Silakan masukkan username terlebih dahulu',
                confirmButtonColor: '#6366f1'
            });
            return;
        }
        ...
        setTimeout(() => {
            ...
            Swal.fire({
                title: isAvailable ? 'Username Tersedia!' : 'Username Sudah Digunakan',
                text: isAvailable ?
                    `Username "${username}" tersedia untuk digunakan` : `Username "${username}" sudah digunakan, silakan coba yang lain`,
                icon: isAvailable ? 'success' : 'error',
                confirmButtonColor: '#6366f1',
                showCancelButton: !isAvailable,
                cancelButtonText: 'OK',
                confirmButtonText: isAvailable ? 'Gunakan Ini' : 'Cari Yang Lain'
            });
        }, 800);
    }
    ...
    document.getElementById('nama_lengkap').addEventListener('input', function() {
        ...
        checkIcon.style.opacity = this.value.length > 2 ? '1' : '0';
    });

    document.getElementById('email').addEventListener('input', function() {
        const checkIcon = document.getElementById('email-check');
        const emailPattern = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
        checkIcon.style.opacity = emailPattern.test(this.value) ? '1' : '0';
    });
